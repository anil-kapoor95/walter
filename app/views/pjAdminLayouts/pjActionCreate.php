...
if (isset($tpl['status']))
{
	...
	?>
	<?php pjUtil::printNotice(__('infoAddLayoutTitle', true, false), __('infoAddLayoutDesc', true, false)); ?>
	
	<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
	<div class="multilang"></div>
	<?php endif; ?>
	
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminLayouts&amp;action=pjActionCreate" method="post" id="frmCreateLayout" class="form pj-form" autocomplete="off" enctype="multipart/form-data">
		<input type="hidden" name="layout_create" value="1" />
		...
		<p>
			...
			<span class="inline_block">
				<input type="file" name="image" id="image" class="pj-form-field w400 required" data-msg-required="<?php __('pj_field_required');?>"/>
			</span>
		</p>
