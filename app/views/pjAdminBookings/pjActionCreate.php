						...
						<div class="float_left w50p overflow">
							<p>
								...
								<span class="pj-form-field-custom pj-form-field-custom-after">
									<input type="text" name="start_date" class="pj-form-field pointer w100 datepicker" readonly="readonly" rel="<?php echo $week_start; ?>" rev="<?php echo $jqDateFormat; ?>"/>
									<input type="hidden" name="validate_start_date" value="" class="required" data-msg-required="<?php __('pj_field_required');?>" data-msg-remote="<?php __('lblSelectedDateOff');?>"/>
									<span class="pj-form-field-after"><abbr class="pj-form-field-icon-date"></abbr></span>
								</span>
							</p>
							<p id="pjMrbEndDate" class="none">
								<label class="title"><?php __('lblEndDate'); ?></label>
								<span class="pj-form-field-custom pj-form-field-custom-after">
									<input type="text" name="end_date" class="pj-form-field pointer w100 datepicker" readonly="readonly" rel="<?php echo $week_start; ?>" rev="<?php echo $jqDateFormat; ?>"/>
									<input type="hidden" name="validate_end_date" value="" class="required" data-msg-required="<?php __('pj_field_required');?>" data-msg-remote="<?php __('lblRangeDaysOff');?>"/>
									<input type="hidden" name="validate_date_range" value="" data-msg-remote="<?php __('lblInvalidDateRange');?>"/>
									<span class="pj-form-field-after"><abbr class="pj-form-field-icon-date"></abbr></span>
								</span>
							</p>
							<p>
								<label class="title"><?php __('lblAttendees'); ?></label>
								<input type="text" name="attendees" id="attendees" value="1" class="pj-form-field field-int w100 digits required" data-msg-required="<?php __('pj_field_required');?>" data-msg-digits="<?php __('pj_digits_validation');?>" data-msg-max="<?php __('pj_attendees_validation')?>"/>
							</p>
							<p>
								...
								<span class="inline_block">
									<select name="room_id" id="room_id" class="pj-form-field w150 required" data-msg-required="<?php __('pj_field_required');?>">
										...
										{
											?><option value="<?php echo $v['id'];?>" data-capacity="<?php echo (int) $v['capacity'];?>"><?php echo pjSanitize::html($v['title']); ?></option><?php
										} 
										?>
									</select>
								</span>
						...
						<div class="float_left w50p overflow">
							...
							<p>
								...
								<span class="pj-form-field-custom pj-form-field-custom-before">
									...
									<input type="text" id="room_price" name="room_price" class="pj-form-field number w80" readonly="readonly"/>
								</span>
							</p>
							<p>
								...
								<span class="pj-form-field-custom pj-form-field-custom-before">
									<span class="pj-form-field-before"><abbr class="pj-form-field-icon-text"><?php echo pjUtil::formatCurrencySign(NULL, $tpl['option_arr']['o_currency'], ""); ?></abbr></span>
									<input type="text" id="equipment_price" name="equipment_price" class="pj-form-field number w80" readonly="readonly"/>
								</span>
							</p>
							<p>
								...
								<span class="pj-form-field-custom pj-form-field-custom-before">
									<span class="pj-form-field-before"><abbr class="pj-form-field-icon-text"><?php echo pjUtil::formatCurrencySign(NULL, $tpl['option_arr']['o_currency'], ""); ?></abbr></span>
									<input type="text" id="food_drink_price" name="food_drink_price" class="pj-form-field number w80" readonly="readonly"/>
								</span>
							</p>
							<p>
									...
									foreach($tpl['equipment_arr'] as $k => $v)
									{
										...
										<tr>
											...
											<td>
												...
												if($v['multi_units'] == 'T')
												{
													?><input type="text" name="units[<?php echo $v['id'];?>]" value="1" class="pj-form-field field-int w80 digits" data-type="equipment" data-id="<?php echo $v['id'];?>" data-msg-digits="<?php __('pj_digits_validation');?>"/><?php
												}else{
													?>1<input type="hidden" name="units[<?php echo $v['id'];?>]" value="1"/><?php
												}
												?>
											</td>
											<td><?php echo pjUtil::formatCurrencySign($v['price'], $tpl['option_arr']['o_currency']) . ' ' . $price_per[$v['price_per']];?></td>
											<td><input type="checkbox" id="checkunit_<?php echo $v['id'];?>" name="equipment_id[<?php echo $v['id'];?>]" value="<?php echo $v['price'];?>|<?php echo $v['price_per'];?>" class="pjMrbEquipmentCheck"/></td>
										</tr>
										<?php
									} 
									?>
							...
							<table class="pj-table" style="width: 100%; margin-bottom: 10px;">
								...
								<tbody>
									...
									foreach($tpl['food_drink_arr'] as $k => $v)
									{
										...
										<tr>
											<td><?php echo pjSanitize::html($v['title']);?></td>
											<td><input type="text" name="people[<?php echo $v['id'];?>]" value="1" class="pj-form-field field-int w80 digits" data-type="food_drinks" data-id="<?php echo $v['id'];?>" data-msg-digits="<?php __('pj_digits_validation');?>"/></td>
											<td><?php echo pjUtil::formatCurrencySign($v['price'], $tpl['option_arr']['o_currency']);?> <?php __('lblPerAttendee');?></td>
											<td><input type="checkbox" id="checkfooddrinks_<?php echo $v['id'];?>" name="food_drink_id[<?php echo $v['id'];?>]" value="<?php echo $v['price'];?>" class="pjMrbFoodCheck"/></td>
										</tr>
										<?php
									} 
									?>
