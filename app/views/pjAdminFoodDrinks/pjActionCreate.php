...
if (isset($tpl['status']))
{
	...
	?>
	<?php pjUtil::printNotice(__('infoAddFoodDrinkTitle', true, false), __('infoAddFoodDrinkDesc', true, false)); ?>
	
	<?php if ((int) $tpl['option_arr']['o_multi_lang'] === 1 && count($tpl['lp_arr']) > 1) : ?>
	<div class="multilang"></div>
	<?php endif; ?>
	
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminFoodDrinks&amp;action=pjActionCreate" method="post" id="frmCreateFoodDrink" class="form pj-form" autocomplete="off" enctype="multipart/form-data">
		<input type="hidden" name="food_drink_create" value="1" />
