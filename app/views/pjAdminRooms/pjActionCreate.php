	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminRooms&amp;action=pjActionCreate" method="post" id="frmCreateRoom" class="form pj-form" autocomplete="off" enctype="multipart/form-data">
		...
		<p>
			...
			<span class="inline_block">
				...
				<span class="block t5 float_left r20"><input type="checkbox" id="book_by_combo" class="block float_left r5"/><label class="block float_left" for="book_by_combo"><?php echo $book_by['combo'];?></label></span>
		...
		<p id="comboSubOptions" class="priceTitle none">
			...
			<span class="inline_block">
				<span class="block t5 float_left r20"><input type="checkbox" id="book_by_morningafternoon" name="book_by_morningafternoon" value="T" class="block float_left r5"/><label class="block float_left" for="book_by_morningafternoon"><?php echo $book_by['morningafternoon'];?></label></span>
				<span class="block t5 float_left r20"><input type="checkbox" id="book_by_afternoonevening" name="book_by_afternoonevening" value="T" class="block float_left r5"/><label class="block float_left" for="book_by_afternoonevening"><?php echo $book_by['afternoonevening'];?></label></span>
			</span>
		</p>
