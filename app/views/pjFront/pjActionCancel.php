		...
		if (isset($tpl['arr']))
		{
			...
			<table class="table" cellspacing="2" cellpadding="5" style="width: 100%">
				...
				<tbody>	
					...
					<tr>
						<td><?php __('front_room'); ?></td>
						<td><?php echo $tpl['arr']['room']; ?></td>
					</tr>
					<tr>
						<td><?php __('front_layout'); ?></td>
						<td><?php echo $tpl['arr']['layout']; ?></td>
					</tr>
					<tr>
						<td><?php __('front_date'); ?></td>
						<td><?php echo date($tpl['option_arr']['o_date_format'], strtotime($tpl['arr']['start_date'])); ?></td>
					</tr>
