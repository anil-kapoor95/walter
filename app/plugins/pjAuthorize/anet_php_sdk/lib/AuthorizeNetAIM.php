...
class AuthorizeNetAIM_Response extends AuthorizeNetResponse
{
    ...
    public function __construct($response, $delimiter, $encap_char, $custom_fields)
    {
        if ($response) {
            ...
            $this->address              = $this->_response_array[15];
            $this->zip_code             = $this->_response_array[16];
			$this->city                 = $this->_response_array[17];
            $this->state                = $this->_response_array[18];
            $this->country              = $this->_response_array[19];
			$this->company              = $this->_response_array[20];
            ...
            $this->ship_to_address      = $this->_response_array[26];
            $this->ship_to_zip_code     = $this->_response_array[27];
			$this->ship_to_city         = $this->_response_array[28];
            $this->ship_to_state        = $this->_response_array[29];
            $this->ship_to_country      = $this->_response_array[30];
			$this->ship_to_company      = $this->_response_array[31];
