...
class pjBookingModel extends pjAppModel
{
	...
	protected $schema = array(
		...
		array('name' => 'book_by', 'type' => 'enum', 'default' => ':NULL'),
		array('name' => 'start_date', 'type' => 'date', 'default' => ':NULL'),
		array('name' => 'end_date', 'type' => 'date', 'default' => ':NULL'),
		array('name' => 'attendees', 'type' => 'int', 'default' => ':NULL'),
		array('name' => 'hours', 'type' => 'int', 'default' => ':NULL'),
		array('name' => 'room_price', 'type' => 'decimal', 'default' => ':NULL'),
		array('name' => 'equipment_price', 'type' => 'decimal', 'default' => ':NULL'),
		array('name' => 'food_drink_price', 'type' => 'decimal', 'default' => ':NULL'),
